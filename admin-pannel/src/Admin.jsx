...
export const getData = (setDatalist) => {
  axios
    .get("https://subhajit-blog-profile-backend.onrender.com/subhajit/profile/show")
    .then((res) => {
...
function Admin() {
  ...
  //     axios
  //       .get("http://localhost:8000/subhajit/profile/show")
  //       .then((res) => {
  //         console.log("API Response:", res.data);
  //         setDatalist(res.data.datalist);
  //       })
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">
               dREAM rIDE wITH sUBHO
              </h1>
              <p className="text-gray-400">
                Manage viewer entries and communications
              </p>
            </div>
                  ...
                  paginatedData.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                          ...
                          <div className="flex items-center space-x-3">
                            <div
                              className={`w-10 h-10 rounded-full ${getRandomColor(
                                item.fullName
                              )} flex items-center justify-center font-bold text-sm text-white shadow-lg`}
                            >
                        ...
                        <td className="px-6 py-4">
                          <div className="max-w-xs flex justify-center items-center h-full">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-700">
              <h2 className="text-2xl font-bold text-white">Viewer Details</h2>
              <button
                onClick={closeModal}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center space-x-4 mb-6">
                <div
                  ...
                  )} flex items-center justify-center font-bold text-xl text-white shadow-lg`}
                >
                ...
                <div>
                  ...
                  <p className="text-gray-400">Viewer</p>
              ...
              {selectedUser.subject && (
                <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
                  ...
                  <div className="bg-gray-800 p-3 rounded-lg border border-gray-600">
                    <span className="bg-blue-800 bg-opacity-20 text-white px-3 py-1 rounded-full text-sm font-medium">
                      {selectedUser.subject}
                    </span>
                  </div>
                </div>
